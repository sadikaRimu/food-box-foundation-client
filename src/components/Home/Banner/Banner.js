      ...
      <div>
        <div className="bg-gradient-to-tl from-sky-900 to-green-900 h-96 w-full relative">
          ...
          <div className="p-24 text-center">
            ...
            <h2 className="text-slate-300 text-3xl font-light hidden lg:block">
              Lorem ipsum dolor sit amet, usu cu esse possit referrentur, Lorem
              ipsum dolor sit amet, usu cu esse possit referrentur
            </h2>
            <a href="/donate">
